# nSDK
nSDK is a Windows-only extension SDK for Clickteam Fusion 2.5. I created this to learn more about the inner workings of Fusion, as well as solve some personal gripes I had with the official SDK. It is based on [Fusion 2.5 SDK](https://www.clickteam.com/extensions-sdks#tabs-2), but the extensions use a brand new Visual Studio project rewritten from the ground up instead of using the official template provided.
