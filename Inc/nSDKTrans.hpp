...
public:
	...
	// Information:
	// -----
	// Depending on what is returned here (some non-zero values), Unknown2 is probably called..
...
public:
	...
	// Unknown functions (that Fusion might call, but not documented):
	// -----
	// Don't actually know if this is the correct signature, I've never had this called
	virtual bool32 FUSION_API Unknown1();
	// If TRUE is returned here then Unknown3 is called
	// unknown1 is hardcoded to 1
